...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of FightSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about FightSwap and more!',
  'Gaming Announcements',
  'FightSwap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with FightSwap Now',
  'Bring Your Game to Life on FightSwap',
  ...
  'FightSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'FightSwap Gaming Marketplace',
  'Play, Build and Connect on FightSwap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
