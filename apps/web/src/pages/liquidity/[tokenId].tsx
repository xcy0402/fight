...
import { isPoolTickInRange, MasterChefV3, NonfungiblePositionManager, Pool, Position } from '@pancakeswap/v3-sdk'
    ...
    inRange && ownsNFT && hasActiveFarm && !isStakedInMCv3 && !hasMerkl ? (
      <Message variant="primary" mb="2em">
        <Box>
          ...
          <Text display="inline">
            {t(
              'has an active SimbSwap farm. Stake your position in the farm to start earning with the indicated APR with CAKE farming.',
            )}
          </Text>
