  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about SimbSwap must reflect your honest opinions, beliefs, or experiences and must
        ...
        <Text as="p">You warrant, represent, and undertake to SimbSwap that:</Text>
        ...
        <Text as="p">
          14.1 SimbSwap reserves the right to terminate this Agreement in its entirety with or without cause, effective
        ...
        <Text as="p">
          14.2 SimbSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse any
        ...
        <Text as="p">14.3 SimbSwap reserves the right to refuse service to anyone for any reason at any time.</Text>
