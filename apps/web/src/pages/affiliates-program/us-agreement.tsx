...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">FightSwap Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: Sep 1, 2023</Text>
        <Text as="p">
          This FightSwap Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and FightSwap that applies to your participation in the FightSwap Affiliate
          Program (“Program”). In this Agreement, “<strong>FightSwap</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means FightSwap. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by FightSwap.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on FightSwap, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the FightSwap platform or used
          any of FightSwap’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“FightSwap
          Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on FightSwap V2 and FightSwap V3, limited
        ...
        <Text as="p">
          ...
          <Text as="p">
            BNB Smart Chain:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-extended.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-extended.json
            </Link>
          </Text>
          <Text as="p">
            Arbitrum One:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-arbitrum-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-arbitrum-default.json
            </Link>
          </Text>
          <Text as="p">
            Base:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-base-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-base-default.json
            </Link>
          </Text>
          <Text as="p">
            Ethereum:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-eth-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-eth-default.json
            </Link>
          </Text>
          <Text as="p">
            Linea:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-linea-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-linea-default.json
            </Link>
          </Text>
          <Text as="p">
            Polygon zkEVM:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-polygon-zkevm-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-polygon-zkevm-default.json
            </Link>
          </Text>
          <Text as="p">
            zkSync Era:
            <Link href="https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-zksync-default.json">
              https://tokenlists.org/token-list?url=https://tokens.FightSwap.finance/FightSwap-zksync-default.json
            </Link>
          </Text>
        ...
        <Text as="p">
          7.3 Any statements you make about FightSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to PancakSwap that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of FightSwap for any purpose.
          ...
          offers or representations on behalf of FightSwap. You shall have no authority to bind FightSwap, and
          undertake not to hold yourself out as an employee, agent or authorised representative of FightSwap.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and FightSwap, or attribute any
          materials created or issued by you (including press releases) to FightSwap.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 FightSwap reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the FightSwap website
          and all images of FightSwap and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 FightSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other FightSwap service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 FightSwap reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify FightSwap from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          FightSwap and any of FightSwap&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of FightSwap Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any FightSwap products and services to users in the
        ...
        <Text as="p">
          FightSwap may provide you with trademarks and/or graphical images that can be used to promote FightSwap.
          You may not modify these trademarks and/or images in any way. FightSwap reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting FightSwap. For example:
        </Text>
        <Text as="p">
          (a) If you promote FightSwap through a web page, podcast, blog post, or social media post as an endorsement
          or review of FightSwap or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by FightSwap; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by FightSwap from time to
