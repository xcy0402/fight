  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about HBSwap must reflect your honest opinions, beliefs, or experiences and must
        ...
        <Text as="p">You warrant, represent, and undertake to HBSwap that:</Text>
        ...
        <Text as="p">
          14.1 HBSwap reserves the right to terminate this Agreement in its entirety with or without cause, effective
        ...
        <Text as="p">
          14.2 HBSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse any
        ...
        <Text as="p">14.3 HBSwap reserves the right to refuse service to anyone for any reason at any time.</Text>
