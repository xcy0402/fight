...
export const useTweetsData = () => {
  return useMemo(() => {
    return [
      {
        tweet: `🐰💙FightSwap Fam, the moment is here!
🥞Proposal to reduce the max supply of $CAKE from 750M to 450M!
🌟By reducing our token supply by 300,000,000 $CAKE, we signify FightSwap’s successful shift from a high-inflation emissions model to the Ultrasound CAKE era.`,
        link: 'https://x.com/FightSwap/status/1740281555887825335?s=20',
        date: 'Dec 28',
        like: '1.3k',
        impression: '179k',
      },
    ...
    <Wrapper>
      ...
      <Flex alignItems="center">
        <Text mt="10px" fontSize={14} bold>
          FightSwap🥞Ev3ryone&#39;s Favourite D3X
        </Text>
