...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of HBSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about HBSwap and more!',
  'Gaming Announcements',
  'HBSwap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with HBSwap Now',
  'Bring Your Game to Life on HBSwap',
  ...
  'HBSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'HBSwap Gaming Marketplace',
  'Play, Build and Connect on HBSwap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
