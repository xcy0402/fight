...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of SimbSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about SimbSwap and more!',
  'Gaming Announcements',
  'SimbSwap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with SimbSwap Now',
  'Bring Your Game to Life on SimbSwap',
  ...
  'SimbSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'SimbSwap Gaming Marketplace',
  'Play, Build and Connect on SimbSwap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
